      ...
      {loading && (
        <>
          <div className="bg-gray-900 relative h-screen">
            <div className="absolute right-1/2 bottom-1/2 transform translate-x-1/2 translate-y-1/2 pb-24">
              <div className="border-t-transparent border-solid animate-spin rounded-full border-blue-400 border-8 h-36 w-36"></div>
            </div>
            <div>
              <p className="text-2xl pt-40 text-darkblue absolute right-1/2 bottom-1/2 transform translate-x-1/2 translate-y-1/2">
              ...
              <div className="max-w-screen-md w-full p-8 relative z-10">
                <div>
                  ...
                  <p className="text-2xl font-medium text-white  font-poppins px-6">
                    Lend, borrow, and earn leveraged yield with DeFi's leading
