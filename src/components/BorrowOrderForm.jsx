        ...
        <div className="mb-8">
          ...
          <div className="mb-5 flex">
            ...
            <button
              ...
              className={`text-white bg-blue-600 w-36 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 text-center inline-flex items-center ${
        ...
        <div className="mb-8">
          ...
          <div className="mb-5 flex">
            ...
            <button
              ...
              className={`text-white w-36 bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-4 text-center inline-flex items-center ${
